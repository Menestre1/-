...
Процедура ПеренестиЗначенияИзРеквизитовФормыВОбъект(Форма, Объект = Неопределено, ПередЗаписью = Ложь) Экспорт
	...
	Для каждого Строка Из Форма.Свойства_ОписаниеДополнительныхРеквизитов Цикл
		...
		Если Не РеквизитВиденИДоступен(Форма, Строка.ИмяРеквизитаЗначение) Тогда
			Продолжить;
		КонецЕсли;
...
//
Функция ДополнительныеРеквизитыИСведенияНеНайдены(Наборы, ЭтоДополнительноеСведение) Экспорт
...
//
Функция РеквизитВиденИДоступен(Форма, ИмяРеквизита)
