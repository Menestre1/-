...
//   СтандартныеПодсистемыКлиент.ПоказатьРезультатВыполнения().
//
Процедура ОповеститьДинамическиеСписки(Результат, СсылкаИлиТипИлиМассив) Экспорт
	...
	ТипЗначения = ТипЗнч(СсылкаИлиТипИлиМассив);
...
//       * НуженВызовСервера - Булево - Ложь когда вычисление на клиенте нецелесообразно и нужен вызов сервера.
//
// См. также:
