...
Функция РазрешенныеЗначенияДляДинамическогоСписка(Таблица, ТипЗначений) Экспорт
	...
	|ИЗ
	|	&ТаблицаЗначенийДоступа КАК ЗначенияБезГрупп
	|ГДЕ
	|	ИСТИНА В
	|			(ВЫБРАТЬ ПЕРВЫЕ 1
	|				ИСТИНА
	...
	|ИЗ
	|	&ТаблицаЗначенийДоступа КАК ЗначенияСГруппами
	|ГДЕ
	|	ИСТИНА В
	|			(ВЫБРАТЬ ПЕРВЫЕ 1
	|				ИСТИНА
	...
	|ИЗ
	|	&ТаблицаЗначенийДоступа КАК ВсеЗначения";
...
//	// ...
//	//Назначение профиля для всех типов внешних пользователей.
//	//Для обычных пользователей назначение задано по умолчанию.
...
Функция НовоеОписаниеПрофиляГруппДоступа() Экспорт
	...
	Назначение = ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Тип("СправочникСсылка.Пользователи"));
	...
	НовоеОписание.Вставить("Назначение",      Назначение); // Массив
