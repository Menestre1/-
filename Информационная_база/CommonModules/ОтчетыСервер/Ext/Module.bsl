	...
	Иначе
		...
		Если НастройкиСохраненныеРанее <> Неопределено
			...
			Если ТипЗнч(СтарыеЗначенияДляВыбора) = Тип("СписокЗначений") И ТипЗнч(СтароеОписаниеТипов) = Тип("ОписаниеТипов") Тогда
				...
				ОтчетыКлиентСервер.ДополнитьСписок(НастройкаВарианта.ЗначенияДляВыбора, СтарыеЗначенияДляВыбора, Неопределено, Истина);
			КонецЕсли;
		КонецЕсли;
...
Процедура ВывестиЭлементыНастройки(Форма, Элементы, СвойстваНастройки, ГруппаВывода, Прочее) Экспорт
	...
	Если СвойстваНастройки.ТипЭлементов <> "" Тогда
		...
		ИначеЕсли СвойстваНастройки.ТипЭлементов = "СтандартныйПериод" Тогда
			...
			ВидПериодаИмя           = СтрШаблон(ШаблонИмениЭлемента, "Вид");
			ПредставлениеИмя        = СтрШаблон(ШаблонИмениЭлемента, "Представление");
			...
			СтраницыИмя             = СтрШаблон(ШаблонИмениЭлемента, "Страницы");
			СтраницаСтандартныйИмя  = СтрШаблон(ШаблонИмениЭлемента, "СтраницаСтандартный");
			СтраницаПроизвольныйИмя = СтрШаблон(ШаблонИмениЭлемента, "СтраницаПроизвольный");
