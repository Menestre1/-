...
Процедура ЗаписатьВремяВыполненияОбновления(ВремяНачалаОбновления, ВремяОкончанияОбновления) Экспорт
	...
	ПродолжительностьЧасы = ?(Часы = 0, "", СтрШаблон(НСтр("ru = '%1 час'"), Часы));
	ПродолжительностьМинуты = ?(Минуты = 0, "", СтрШаблон(НСтр("ru = '%1 мин'"), Минуты));
	ПродолжительностьСекунды = ?(Секунды = 0, "", СтрШаблон(НСтр("ru = '%1 сек'"), Секунды));
