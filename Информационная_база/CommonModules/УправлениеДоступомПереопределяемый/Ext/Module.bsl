...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	НСтр("ru = 'Предназначен для респондентов (внешних пользователей), работающих с программой.'");
	...
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваТестирование");
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеОтветовНаВопросыТестов");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеОтветовНаВопросыТестов");
