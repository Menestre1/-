...
Процедура ЗаполнитьНазначениеПрофилейГруппДоступа() Экспорт
	...
	|	ПрофилиГруппДоступа.Назначение.(
	|		Ссылка,
	|		НомерСтроки,
	|		ТипПользователей
	|	)
	...
	|			ИЛИ ПрофилиГруппДоступа.ПоставляемыйПрофильИзменен)
...
//
Процедура ЗаписатьНаборыЗначенийДоступа(Знач Объект, ЕстьИзменения = Неопределено)
...
//                 Если получена ссылка, то по ней будет получен объект.
//
Процедура ЗаписатьЗависимыеНаборыЗначенийДоступа(Знач Объект)
...
Функция ГруппыСтрокВСтроку(ГруппыСтрок)
	...
	Возврат СтрШаблон(Шаблон, Строки, ",");
