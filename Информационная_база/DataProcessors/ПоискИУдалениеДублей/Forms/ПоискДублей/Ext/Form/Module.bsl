...
Процедура ПриСозданииНаСервереИнициализацияДанных(НастройкиФормы)
	...
	НастройкиОбъектовМетаданных = ОбработкаОбъект.ОбластиПоискаДублей(Истина);
...
Процедура ОбновитьОписаниеПравилПоиска()
	...
	Для Каждого Правило Из ПравилаПоиска Цикл
		...
		ТекстПравил = ТекстПравил + ?(ТекстПравил = "" Или Сравнение = "", "", Союз) + Сравнение;
	КонецЦикла;
...
Процедура ИнициализироватьКомпоновщикОтбораИПравила(НастройкиФормы)
	...
	ЭлементСписка = НастройкиОбъектовМетаданных.НайтиПоЗначению(ОбластьПоискаДублей);
