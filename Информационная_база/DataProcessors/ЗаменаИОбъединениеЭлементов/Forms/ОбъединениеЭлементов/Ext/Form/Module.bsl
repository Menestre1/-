...
Процедура СформироватьПодсказкуОбъединения()
	...
	ТекстПодсказки = СтрШаблон(ТекстПодсказки, МестаИспользования.Количество()-1, ОсновнойЭлемент);
...
Процедура ЗаполнитьМестаИспользования(Знач ТаблицаИспользования)
	...
	ТекстЗаголовка = СтрШаблон(НСтр("ru = 'Объединение элементов %1 в один'"), Представление);
КонецПроцедуры
