...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.АктивныеПользователи.Заголовок = СтрШаблон(АктивныеПользователиШаблон, КоличествоАктивныхСеансов);
...
Процедура ОбновитьКоличествоАктивныхСеансов()
	...
	Если Результат = 0 Тогда
		Закрыть(Ложь);
	Иначе
		Элементы[АктивныеПользователи].Заголовок = СтрШаблон(АктивныеПользователиШаблон, Результат);
	КонецЕсли;
