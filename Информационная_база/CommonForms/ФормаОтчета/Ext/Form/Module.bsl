...
Процедура ПриОткрытии(Отказ)
	...
	ПеременныеКлиента.Вставить("Непосредственно", ТипЗнч(НастройкиОтчета.ОтчетСсылка) = Тип("Строка"));
...
Процедура Сформировать()
	...
	Если ПеременныеКлиента.Непосредственно Тогда
		ТребуетсяОбработчик = Ложь;
...
Процедура ВидимостьДоступностьКорректность(Изменения = "")
	...
	Если Изменения = "" Тогда
		...
		Элементы.ГруппаНастройкиОтчета.Видимость = ПоказыватьКомандыВариантовОтчетов;
...
Функция ФоновоеЗаданиеЗапустить(Знач ФормированиеПриОткрытии)
	...
	Если НастройкиОтчета.ВыполнятьЗамеры Тогда
...
Функция ФоновоеЗаданиеПроверитьНаСервере()
	Задание = ДлительныеОперации.НайтиЗаданиеСлужебный(ФоновоеЗаданиеИдентификатор);
